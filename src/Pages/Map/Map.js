...
// import AddLocation from "./locatin.png";

// export function Map() {
//   return (
//     <Box style={myStyle.contener}>
//       <figure style={myStyle.selectLoacationFigure}>
//         <img src={AddLocation} alt="" style={myStyle.selectLoacation} />
//       </figure>
